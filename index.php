            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link js-scroll-trigger" href="index.php?page=achievers">Achievers</a></li>
                        ...
                        <a href="chatbox.php">  <i style="font-size:28px;color:white" class="fa"> 	&#xf27a</i></a>
                        ...
                        <li class="nav-item">
                          ...
                          <li><i style="font-size:28px;color:white" class="fa"> &#xf4ad</i> 
...
<div class="modal fade" id="confirm_modal" role='dialog'>
  ...
  <div id="preloader"></div>
        <footer class=" py-5">
            ...
            <div class="container">
            <div class="small text-center text-muted">06/01/2024 - <?php echo $_SESSION['system']['name'] ?> | WEB WIZARDS</div></div>
        </footer>
